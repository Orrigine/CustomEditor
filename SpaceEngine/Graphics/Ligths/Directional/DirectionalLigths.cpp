...
DirectionalLigths::DirectionalLigths(DirectX::XMFLOAT3 position, std::string* filename, float intensity, float precision, DirectX::XMVECTOR dir)
{
	this->Position = position;
	this->filenameShader = filename;
